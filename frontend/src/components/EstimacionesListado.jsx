  ...
  return (
    <>
      ...
      <a  href="/estimaciones/crear" className="btn btn-success ">
        Agregar Estimacion href <i className="fa fa-plus-square" aria-hidden="true"></i>
      </a>
...

          {
            dataMuro.map( (item) => (
              <tr>
                ...
                <td className="col-1">
                    <a href={"/estimaciones/editar/"+item.id}                 
                    className="btn btn-warning">Editar/link
                    <i className="fa fa-pencil-square-o" aria-hidden="true"></i>
                  </a>                  
                </td>
                <td className="col-1">
                    <button onClick={ ()=> editarPublicacion(item.id) }  className="btn btn-warning mx-2" >Editar/b</button>   
                </td>
              </tr>
            ))
          }
